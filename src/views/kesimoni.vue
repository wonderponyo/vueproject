    ...
    <div>
        ...
        <div id="content" class="content">
            ...
            <div class="centerks l">
                <fieldset>
                    <legend>本项练习共计 <font id="id_count"><b>50</b> </font> 题</legend>
                    <div class="st">
            ...
            <div class="right r">
                <fieldset>
                    <legend>答题信息</legend>
                    <dl >
                        <dd  v-for="count in 50" v-bind:id="count" v-on:click="configflag(count)" ><strong>{{count}}</strong>
                            <div></div>
                        </dd>
...
<script >
	...
	export default {
		...
		created() {
			...
			const _this=this;
			axios.get('http://localhost:8181/springboot/byRand/4').then(function (resp) {
